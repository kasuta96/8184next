  ...
  const Tabs = ({ id = "", original, translation }) => {
    ...
    return (
      <div className="my-6">
        <a
          className={
            "px-5 py-3 shadow-sm rounded block " +
            (openTrans == true
          ...
          href={"#trans" + id}
        >
          <svg width="20" height="20" className="float-right text-indigo-300" fill="currentColor" viewBox="0 0 469.333 469.333" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className={openTrans == false ? 'block' : 'hidden'}>
            <Tag data={original} />
          </div>
          <div className={openTrans == true ? 'block' : 'hidden'}>
